...
public class RobotStatusInfo {
     ...
     * 机器人当前急停状态
     */
    private int mEmergence;
    /**
     * 机器人当前诊断状态
     */
    private int mDiagnose;
    /**
     * 机器人当前工程ID
     */
     ...
     * 是否预约充电
     */
    private boolean mReservationBattery;

    /**
     * 预约充电开始时间
     */
    private String mReservationStartTime;
    /**
     * 预约充电结束时间
     */
